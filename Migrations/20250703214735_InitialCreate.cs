        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerHour_Amount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    PricePerHour_Currency = table.Column<string>(type: "nvarchar(3)", maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeRange_StartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    TimeRange_EndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Rooms_MotelId_RoomNumber",
                table: "Rooms",
                columns: new[] { "MotelId", "RoomNumber" },
                unique: true);
        }
